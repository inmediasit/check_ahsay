...
OK = ['BS_STOP_SUCCESS', 'BS_STOP_SUCCESS_WITH_ERROR', 'BS_STOP_SUCCESS_WITH_WARNING', 'OK']
WARNING = ['BS_STOP_BY_USER']
CRITICAL = ['BS_STOP_BY_SYSTEM_ERROR', 'BS_STOP_BY_SCHEDULER', 'BS_STOP_BY_QUOTA_EXCEEDED', 'BS_STOP_MISSED_BACKUP', 'BS_BACKUP_NOT_FINISHED', 'BS_MISSED_DATABASAE', 'BS_MISSED_PUBLIC_FOLDER', 'BS_MISSED_VIRTUAL_MACHINE', 'BS_STILL_RUNNING', 'BS_STOP_INCOMPLETE' ]
exit_code = 0
